...
// Purpose: Reads the installed Koder package version and caches the latest published npm version.
// Layer: CLI helper
...
const KODER_REGISTRY_URL = "https://registry.npmjs.org/koder/latest";
...
function createBridgePackageVersionStatusReader({
  ...
  registryUrl = KODER_REGISTRY_URL,
