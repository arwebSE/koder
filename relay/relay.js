// FILE: relay.js
// Purpose: Thin self-hostable WebSocket relay for trusted-session lookup, self-host bootstrap, and encrypted forwarding.
// Layer: Standalone server module
// Exports: setupRelay, getRelayStats, hasActiveMacSession, hasAuthenticatedMacSession, resolveTrustedMacSession, resolveDirectBootstrapSession
...
const TRUSTED_SESSION_RESOLVE_TAG = "koder-trusted-session-resolve-v1";
...
// Resolves the bootstrap metadata for the most recent live self-hosted bridge.
